    ...
    <div class="container-fluid bg-light position-relative shadow">
      ...
      >
        ...
        >
            ...
            <a href="cvr.jsp" class="nav-item nav-link ">View Report</a>
            <a href="cmd.jsp" class="nav-item nav-link active">My Details</a>
...
try{ 
        ...
        PreparedStatement pst=co.prepareStatement("select * from contractor_report where username='"+username+"'");
