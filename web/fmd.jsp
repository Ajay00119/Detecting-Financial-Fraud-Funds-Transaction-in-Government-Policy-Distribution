    ...
    <div class="container-fluid bg-light position-relative shadow">
      ...
      >
        ...
        >
            ...
            <a href="fhome.jsp" class="nav-item nav-link ">Home</a>
            <a href="fad.jsp" class="nav-item nav-link ">Add Details</a>
            <a href="fmd.jsp" class="nav-item nav-link active">My Details</a>
...
try{ 
        ...
        PreparedStatement pst=co.prepareStatement("select * from finance_data where username='"+username+"'");
